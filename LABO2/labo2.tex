...
/Title (LABO 2 ELEC-H-301, Filtrage)
/ModDate (D:\pdfdate)
}
...
\begin{center}
\includegraphics[width=14cm]{AOP2etages}
\end{center}
...
\begin{center}
\includegraphics[width=14cm]{AOPimperfections}
\end{center}
\Question
{
...
\begin{center}
\includegraphics[width=10cm]{AOPetage3}
\end{center}
...
\begin{center}
\includegraphics[width=10cm]{AOPetage32}
\end{center}
...
\begin{center}
\includegraphics[width=10cm]{NJM}
\end{center}
...
\begin{center}
\includegraphics[width=16cm]{AOP3etages}
\end{center}
...
\begin{center}
\includegraphics[width=10cm]{AOPsommateur}
\end{center}
...
\begin{center}
\includegraphics[width=12cm]{AOPfiltres}
\end{center}

Pour expliquer son fonctionnement, prenons le bloc Filtre + volume des basses :
\begin{center}
\includegraphics[width=10cm]{AOPfiltrebasse}
\end{center}
...
\begin{center}
\includegraphics[width=14cm]{AOPfiltreRC}
\end{center}
...
\begin{center}
\includegraphics[width=26cm, angle=90]{AOPmontagetotal}
\end{center}
