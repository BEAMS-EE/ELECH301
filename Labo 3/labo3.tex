...
\Question
{
	Tracez la tension aux deux bornes de la diode. Précisez l'état de la diode. Utilisez une tension de seuil de 1V pour simplifier (\textit{cf} \href{http://www.protostack.com/download/1N5391-9.pdf}{documentation 1N5392}).%\marginpar{donner un graphe ???}
}
