...
\Question{
Sachant que le moteur absorbe 500mA au maximum, que 1$1\Omega$ et que l'on désire une
...
\Question{
A l'aide d'un ampli TLE2061, réalisez le câblage du montage. Alimentez l'ampli en $+12V/-12V$. Les résistances $R_1$ et $R_3$ sont déjà sur la carte et valent $1\Omega$
}
{}
...
sachant que la résistance est de $10\Omega$.
}{}
...
HEF4043 (veillez à mettre l'entrée E0 à l'état haut).
}{}
