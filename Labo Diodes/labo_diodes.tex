...
Attention, le circuit tel que dimensionné comporte un problème d'adaptation d'impédence entre le premier et le deuxième étage. Lorsque la diode Zener est en avalanche, une partie non négligeable du courant du diviseur résistif circule au sein du deuxième étage, diminuant la tension de décalage continue additionnée à $V_i$.
Pour résoudre ce problème, il faudrait utiliser des résistances plus faibles pour le diviseur résistif (et un condensateur plus élevé afin de garder une fréquence de coupure acceptable) ou une résistance beaucoup plus élevée dans le deuxième étage.}
\label{Q:zener_4}
\Question
