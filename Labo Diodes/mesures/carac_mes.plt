...
plot  id(x) t "I(V) (théorique)" lw 5 lc 3 , idp(x) lw 5 lc 3 t "I(V) idéale",  \
 idi(x) t "I(V) idéalisée avec Vth" lw 5 lc 3, "NewFile6.csv" every 100::500000 using ($3-$2):($2/100)-1e-4 smooth bezier  with lines  lw 5 lc 1 t "Mesure"

#plot "./NewFile3.csv" using 3:($2)/100+.06 smooth csplines with lines

set fit logfile "fit.log"
set fit errorvariables
fit id(x) '-' using 1:2 via Is, n
0	0
1.786	0.32e-3
1.900	2.060e-3
1.9981	5.355e-3
