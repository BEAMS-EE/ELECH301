...
\begin{astuce}
	Pour aller plus loin, vous pouvez directement afficher la caractéristique en utilisant le mode XY de l'oscilloscope. Vous pourrez ainsi observer $V_{DS}$ en fonction de $V_{GS}$. Puisque $I_D = \frac{V_{DS} - E}{R_D}$, on peut retrouver la caractéristique par opération graphique.
\end{astuce}
}
{
}
