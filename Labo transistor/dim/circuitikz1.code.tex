...
\def\pgf@circ@ammeternoarrowhrz@path#1{\pgf@circ@bipole@path{ammeternoarrowhrz}{#1}}
\def\pgf@circ@ammeternoarrowvrt@path#1{\pgf@circ@bipole@path{ammeternoarrowvrt}{#1}}
\def\pgf@circ@voltmeternoarrowhrz@path#1{\pgf@circ@bipole@path{voltmeternoarrowhrz}{#1}}
\def\pgf@circ@voltmeternoarrowvrt@path#1{\pgf@circ@bipole@path{voltmeternoarrowvrt}{#1}}
...
\tikzset{ammeternoarrowhrz/.style= {\circuitikzbasekey, /tikz/to path=\pgf@circ@ammeternoarrowhrz@path, l=#1}}
\tikzset{ammeternoarrowvrt/.style= {\circuitikzbasekey, /tikz/to path=\pgf@circ@ammeternoarrowvrt@path, l=#1}}
\tikzset{voltmeternoarrowhrz/.style= {\circuitikzbasekey, /tikz/to path=\pgf@circ@voltmeternoarrowhrz@path, l=#1}}
\tikzset{voltmeternoarrowvrt/.style= {\circuitikzbasekey, /tikz/to path=\pgf@circ@voltmeternoarrowvrt@path, l=#1}}
...
\tikzset{ammeternoarrowhrz/.style = {\circuitikzbasekey, /tikz/to path=\pgf@circ@ammeternoarrowhrz@path}}
\tikzset{ammeternoarrowvrt/.style = {\circuitikzbasekey, /tikz/to path=\pgf@circ@ammeternoarrowvrt@path}}
...
\pgf@circ@definetranspath{nigfetec}
