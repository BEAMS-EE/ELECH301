...
\begin{itemize}
	\item idéale : le \textbf{courant} circulant à travers la diode est \textbf{nul} si la diode est polarisée \textbf{en inverse}, la \textbf{tension} aux bornes de la diode est \textbf{nulle} si elle est polarisée \textbf{en direct} (par rapport au schéma si dessus, polarisation directe $\equiv V>0$).
