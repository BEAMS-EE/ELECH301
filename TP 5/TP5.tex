...
Les courbes en annexe ne permettant pas une résolution graphique, il faut utiliser l'expression de la droite de charge~: $I_D = \frac{-1}{R_D} \cdot V_{DS} + \frac{E}{R_D}$.
